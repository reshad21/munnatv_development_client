...
import UpdateProjectForm from "./_component/UpdateProjectForm";

const UpdateSingleProject = async (props: { params: Promise<{ id: string }> }) => {
  ...
  return (
    <DashboardContainer>
      ...
      />
      <UpdateProjectForm categories={categoryData} project={projectData} />
    </DashboardContainer>
  );
};
